...
if ( ! class_exists( 'maha_social_subscribe' ) ) { 
    class maha_social_subscribe extends WP_Widget {
        ...
        function widget($args, $instance) {
            ...
            $tumblr_blog = $instance['tumblr_blog'];
    		...
    		<div class="social-network twitter">
                <a class="social-network-icon trans-it" target="_blank" href="<?php echo esc_attr( $twitter_count['page_url'] ); ?>" title="<?php _e('Follow our twitter', MAHA_TEXT_DOMAIN); ?>"><i class="tm-twitter trans-it"></i></a>
                <div class="social-network-counter">
                    <div class="social-network-count"><?php echo maha_simply_number( $twitter_count['followers_count'], 1 ); ?></div>
            ...
            <div class="social-network facebook">
                <a class="social-network-icon trans-it" target="_blank" href="<?php echo esc_attr( $facebook_count['page_url'] ); ?>" title="<?php _e('Like our Facebook', MAHA_TEXT_DOMAIN); ?>"><i class="tm-facebook trans-it"></i></a>
                <div class="social-network-counter">
                    <div class="social-network-count"><?php echo maha_simply_number( $facebook_count['fans_count'], 1 ); ?></div>
            ...
            <div class="social-network youtube">
                <a class="social-network-icon trans-it" target="_blank" href="<?php echo esc_attr( $youtube_count['page_url'] ); ?>" title="<?php _e('Subscribe our Youtube', MAHA_TEXT_DOMAIN); ?>"><i class="tm-youtube trans-it"></i></a>
                <div class="social-network-counter">
                    <div class="social-network-count"><?php echo maha_simply_number( $youtube_count['subscriber_count'], 1 ); ?></div>
            ...
            <div class="social-network gplus">
                <a class="social-network-icon trans-it" target="_blank" href="<?php echo esc_attr( $gplus_count['page_url'] ); ?>" title="<?php _e('Follow our Google+', MAHA_TEXT_DOMAIN); ?>"><i class="tm-googleplus trans-it"></i></a>
                <div class="social-network-counter">
                    <div class="social-network-count"><?php echo maha_simply_number( $gplus_count['people_count'], 1 ); ?></div>
            ...
            <div class="social-network instagram">
                <a class="social-network-icon trans-it" target="_blank" href="<?php echo esc_attr( $instagram_count['page_url'] ); ?>" title="<?php _e('Follow our Instagram', MAHA_TEXT_DOMAIN); ?>"><i class="tm-instagram trans-it"></i></a>
                <div class="social-network-counter">
                    <div class="social-network-count"><?php echo maha_simply_number( $instagram_count['follower'], 1 ); ?></div>
            ...
            <div class="social-network rss">
                <a class="social-network-icon trans-it" target="_blank" href="<?php echo esc_attr( $rss_url ); ?>" title="<?php _e('RSS Feeds', MAHA_TEXT_DOMAIN); ?>"><i class="tm-rss trans-it"></i></a>
                <div class="social-network-counter">
            ...
            <div class="social-network pinterest">
                <a class="social-network-icon trans-it" target="_blank" href="<?php echo esc_attr( $pinterest_count['page_url'] ); ?>" title="<?php _e('Pin it', MAHA_TEXT_DOMAIN); ?>"><i class="tm-pinterest trans-it"></i></a>
                <div class="social-network-counter">
                    <div class="social-network-count"><?php echo maha_simply_number( $pinterest_count['followers'], 1 ); ?></div>
            ...
            <?php
            if ( $tumblr_blog ) { $tumblr_count = maha_get_tumblr_count( $tumblr_blog, $widget_id );
            ?>
            <div class="social-network tumblr">
                <a class="social-network-icon trans-it" target="_blank" href="<?php echo esc_attr( $tumblr_count['page_url'] ); ?>" title="<?php _e('Follow our blog', MAHA_TEXT_DOMAIN); ?>"><i class="tm-tumblr trans-it"></i></a>
                <div class="social-network-counter">
                    <div class="social-network-count"><?php echo maha_simply_number( $tumblr_count['followers'], 1 ); ?></div>
                    <div class="social-network-unit"><?php _e($tumblr_label, MAHA_TEXT_DOMAIN); ?></div>
                </div>
                <div class="clearfix"></div>
            </div>
            <?php } ?>
        ...
        function update($new_instance, $old_instance) {
            ...
            $instance['tumblr_blog'] = strip_tags($new_instance['tumblr_blog']);
            $instance['tumblr_label'] = strip_tags($new_instance['tumblr_label']);
            ...
            delete_transient( 'mh_tb_count_'.$this->id );
        ...
        function form($instance) {
            ...
            <p>
                ...
                <span><?php _e('Instagram Username is different with Instagram ID, you can get your Instagram ID by using your Instagram Username via <a target="_blank" href="http://thememaha.com/instagram/">http://thememaha.com/instagram/</a>', MAHA_TEXT_DOMAIN);?> </span>
            </p>
            <p>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('tumblr_blog'); ?>"><?php _e('Tumblr Blog Name', MAHA_TEXT_DOMAIN) ?></label>
                <input class="widefat" id="<?php echo $this->get_field_id('tumblr_blog'); ?>" type="text" name="<?php echo $this->get_field_name('tumblr_blog'); ?>" value="<?php echo $instance['tumblr_blog']; ?>" />
                <span><?php _e('e.g. example.tumblr.com', MAHA_TEXT_DOMAIN);?> </span>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('tumblr_label'); ?>"><?php _e('Thumblr Label ', MAHA_TEXT_DOMAIN) ?></label>
                <input class="widefat" id="<?php echo $this->get_field_id('tumblr_label'); ?>" type="text" name="<?php echo $this->get_field_name('tumblr_label'); ?>" value="<?php echo $instance['tumblr_label']; ?>" />
            </p>
...
if ( ! function_exists( 'maha_pinterest_count' ) ) {
    function maha_pinterest_count( $username, $widget_id ) {
        ...
        $maha_options = get_option('curated');
        $api_url = "https://api.pinterest.com/v1/users/". $username ."/?access_token=". $maha_options['social-pinterest'] ."&fields=counts";
        $pinterest['page_url'] = "https://www.pinterest.com/". $username ."/";
        ...
        if ( function_exists( 'json_last_error' ) && JSON_ERROR_NONE === json_last_error() && ! empty( $json )  && !isset($json->meta->error_type) ) {
            $pinterest['followers'] = $json->data->counts->followers;
        }
...
/*  Get Twitter Followers
================================================== */
if ( ! function_exists( 'maha_get_tumblr_count' ) ) {
	function maha_get_tumblr_count( $tumblr_blog, $widget_id ) {
		$maha_options = get_option('curated');
		$tumblr = get_transient('mh_tb_count_'.$widget_id);

		if ($tumblr !== false && is_array($tumblr)) { if ($tumblr['followers'] != 0) { return $tumblr; } }

		// Load the library
		require_once (MAHA_PATH . '/includes/functions/tumblroauth/tumblroauth.php');

		// Define the needed keys
		$consumer_key = "TzCwtememSHb1DlhMrGqgi1TbXsIJI5glw51qMLsDaU8I1mV5m";
		$consumer_secret = "7LKGtRpbxNDbR9vXSTOIdsOf8o4kEYldcNnTCGXBSrwPaBNLrD";
		$oauth_token = $maha_options['social-tumblr-key'];
		$oauth_token_secret = $maha_options['social-tumblr-secret'];
		$base_hostname = $tumblr_blog;

		$post_URI = 'http://api.tumblr.com/v2/blog/'.$base_hostname.'/followers';

		$tum_oauth = new TumblrOAuth($consumer_key, $consumer_secret, $oauth_token, $oauth_token_secret);

		$post = $tum_oauth->post($post_URI);

		// Check for an error.
		if ( isset( $post->meta->msg ) && 'OK' == $post->meta->msg) {
			$tumblr['page_url'] = '//'.$base_hostname;
			$tumblr['followers'] = $post->response->total_users;
		} else {
			// die('error');
			$tumblr['page_url'] = '';
			$tumblr['followers'] = 0;
			echo "Blog name, token or token secret invalid.";
		}

		set_transient( 'mh_tb_count_'.$widget_id, $tumblr, 60*60*24 ); // 1 Day chace
		return $tumblr;
	}
}
?>