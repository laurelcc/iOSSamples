<?php global $curated; ?>
<div class="item-full-width post-box-full" itemscope itemtype="http://schema.org/Article">
	...
	<div class="meta-info">
		<?php if ( isset( $curated['module_meta']['author'] ) && $curated['module_meta']['author'] != false ) : ?>
			<span itemprop="author" class="entry-author"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php the_author(); ?></a></span>
		<?php endif; ?>
	...
	<div class="thumb-wrap short-bottom zoom-zoom">
		...
		<img itemprop="image" class="<?php echo $thumb_class; ?>" src="<?php echo $thumb; ?>"  alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
		</a>
	</div>
