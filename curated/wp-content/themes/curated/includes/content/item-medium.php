<?php global $curated; ?>
<div class="item-medium post-box-big" itemscope itemtype="http://schema.org/Article">
	...
	<div class="thumb-wrap zoom-zoom">
		...
		<img width="360" height="206" itemprop="image" class="<?php echo $thumb_class; ?>" src="<?php echo $thumb; ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
   		</a>
	</div>
