		...
		<div id="split-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-split">
			...
			<form id="split_topic" name="split_topic" method="post" action="<?php the_permalink(); ?>">
				...
				<fieldset class="bbp-form">
					...
					<legend class="bbp-section-caption"><?php printf( __( 'Split topic "%s"', 'bbpress' ), bbp_get_topic_title() ); ?></legend>
					...
					<div>
						...
						<fieldset class="bbp-form bbp-margin-top">
							<legend class="bbp-section-caption"><?php _e( 'Split Method', 'bbpress' ); ?></legend>
						...
						<fieldset class="bbp-form bbp-margin-top">
							<legend class="bbp-section-caption"><?php _e( 'Topic Extras', 'bbpress' ); ?></legend>
						...
						<div class="bbp-submit-wrapper">
							<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_merge_topic_submit" name="bbp_merge_topic_submit" class="button submit mh-button"><?php _e( 'Submit', 'bbpress' ); ?></button>
						</div>
					</div>
