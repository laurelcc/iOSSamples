...
<body <?php body_class(); ?>>
    ...
    <div id="body-maha" class="body-maha" data-tmloader="<?php echo get_template_directory_uri().'/images/ellipsis.gif'; ?>">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div id="top-right-nav">
                                    ...
                                    <div class="top-user">
                                        ...
                                        <a href="<?php echo wp_logout_url(); ?>"><?php _e('Logout', MAHA_TEXT_DOMAIN); ?></a>
                                        <?php else : ?>
                                        	<?php if ( get_option('users_can_register') ) : ?>
                                                <?php if ( class_exists('LoginWithAjax') ) : ?>
                                                <a class="login-modal-closer" data-reveal-id="cur-register" data-animation="fade" data-dismissmodalclass="register-reveal-modal"><?php _e('Register', MAHA_TEXT_DOMAIN); ?></a>
                                                <?php else : ?>
                                                <a href="<?php echo wp_registration_url(); ?>"><?php _e('Register', MAHA_TEXT_DOMAIN); ?></a>
                                                <?php endif; ?>
                                                <span>&nbsp/&nbsp</span>
                                            <?php endif; ?>
                                            <?php if ( class_exists('LoginWithAjax') ) : ?>
                                            ...
                                            <?php else : ?>
                                                <a href="<?php echo wp_login_url(); ?>"><?php _e('Login', MAHA_TEXT_DOMAIN); ?></a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-12 clearfix">
                            ...
                            // if (class_exists('LoginWithAjax')) {
                               ...
                               <!--  <div id="logout-nav" class="clearfix">
                                    <a class="open-login-form" href="<?php echo wp_logout_url(get_site_url()); ?>" title="Logout"><i class="tm-logout"></i></a>
                                </div> -->
                                <?php //}
                            // }
                            ?>
