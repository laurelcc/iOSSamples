...
<?php endif; ?>
		...
		<div class="woo-maha">
		<h2 class="woo-center"><?php _e( 'Login', 'woocommerce' ); ?></h2>
		<form method="post" class="login">
			...
			<div class="woo-content-fields woo-edit-center">
				...
				<p class="form-row form-nav">
					...
					<input type="submit" class="woocommerce-Button button woo-button" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
				</p>
				<p class="woocommerce-LostPassword lost_password woo-remember-lost">
