...
<div class="lwa mh-custom-default">
    ...
    <form class="lwa-form" action="<?php echo esc_attr(LoginWithAjax::$url_login); ?>" method="post">
        ...
        <div class="lwa-submit-button">
            <input type="submit" name="wp-submit" id="lwa_wp-submit" class="i-button medium" value="<?php esc_attr_e('Log In','login-with-ajax'); ?>" tabindex="100" />
    ...
    <form class="lwa-remember" action="<?php echo esc_attr(LoginWithAjax::$url_remember); ?>" method="post" style="display:none;">
        ...
        <div class="lwa-submit-button">
            <input type="submit" class="i-button medium" value="<?php esc_attr_e("Get New Password", 'login-with-ajax'); ?>" />
    ...
    <div class="lwa-register" style="display:none;" >
        <form class="registerform" action="<?php echo esc_attr(LoginWithAjax::$url_register); ?>" method="post">
            ...
            <p class="lwa-submit-button">
                <input type="submit" name="wp-submit" id="wp-submit" class="button-primary i-button medium" value="<?php esc_attr_e('Register', 'login-with-ajax'); ?>" tabindex="100" />
